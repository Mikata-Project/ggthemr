...
### camoflauge
  ...
  ggthemr('camoflauge', spacing = 0.5, type = 'outer')
  ggthemr:::preview_theme()
  ```
### carrot
  
  ```{r fig.width=10, fig.height=6, echo=FALSE}
  ggthemr('carrot', spacing = 0.5, type = 'outer')
  ggthemr:::preview_theme()
  ```
### chalk
  
  ```{r fig.width=10, fig.height=6, echo=FALSE}
  ggthemr('chalk', spacing = 0.5, type = 'outer')
  ggthemr:::preview_theme()
  ```
### citrus
  
  ```{r fig.width=10, fig.height=6, echo=FALSE}
  ggthemr('citrus', spacing = 0.5, type = 'outer')
  ggthemr:::preview_theme()
  ```
### copper
  
  ```{r fig.width=10, fig.height=6, echo=FALSE}
  ggthemr('copper', spacing = 0.5, type = 'outer')
  ggthemr:::preview_theme()
  ```
### dust
  
  ```{r fig.width=10, fig.height=6, echo=FALSE}
  ggthemr('dust', spacing = 0.5, type = 'outer')
  ggthemr:::preview_theme()
  ```
### earth
  
  ```{r fig.width=10, fig.height=6, echo=FALSE}
  ggthemr('earth', spacing = 0.5, type = 'outer')
  ggthemr:::preview_theme()
  ```
### fresh
  
  ```{r fig.width=10, fig.height=6, echo=FALSE}
  ggthemr('fresh', spacing = 0.5, type = 'outer')
  ggthemr:::preview_theme()
  ```
### grape
  
  ```{r fig.width=10, fig.height=6, echo=FALSE}
  ggthemr('grape', spacing = 0.5, type = 'outer')
  ggthemr:::preview_theme()
  ```
### grass
  
  ```{r fig.width=10, fig.height=6, echo=FALSE}
  ggthemr('grass', spacing = 0.5, type = 'outer')
  ggthemr:::preview_theme()
  ```
### greyscale
  
  ```{r fig.width=10, fig.height=6, echo=FALSE}
  ggthemr('greyscale', spacing = 0.5, type = 'outer')
  ggthemr:::preview_theme()
  ```
### light
  
  ```{r fig.width=10, fig.height=6, echo=FALSE}
  ggthemr('light', spacing = 0.5, type = 'outer')
  ggthemr:::preview_theme()
  ```
### lilac
  
  ```{r fig.width=10, fig.height=6, echo=FALSE}
  ggthemr('lilac', spacing = 0.5, type = 'outer')
  ggthemr:::preview_theme()
  ```
### pale
  
  ```{r fig.width=10, fig.height=6, echo=FALSE}
  ggthemr('pale', spacing = 0.5, type = 'outer')
  ggthemr:::preview_theme()
  ```
### sea
  
  ```{r fig.width=10, fig.height=6, echo=FALSE}
  ggthemr('sea', spacing = 0.5, type = 'outer')
  ggthemr:::preview_theme()
  ```
### sky
  
  ```{r fig.width=10, fig.height=6, echo=FALSE}
  ggthemr('sky', spacing = 0.5, type = 'outer')
  ggthemr:::preview_theme()
  ```
### solarized
  
  ```{r fig.width=10, fig.height=6, echo=FALSE}
  ggthemr('solarized', spacing = 0.5, type = 'outer')
  ggthemr:::preview_theme()
  ```
### solarized dark
  
  ```{r fig.width=10, fig.height=6, echo=FALSE}
  ggthemr('solarized dark', spacing = 0.5, type = 'outer')
  ggthemr:::preview_theme()
  ```
...
ggthemr(spacing = 0, type = 'outer')
ggthemr:::preview_layout()
```

```{r fig.width=5, fig.height=4, echo=FALSE}
ggthemr(spacing = 1, type = 'outer')
ggthemr:::preview_layout()
```

```{r fig.width=5, fig.height=4, echo=FALSE}
ggthemr(spacing = 2, type = 'outer')
ggthemr:::preview_layout()
```
